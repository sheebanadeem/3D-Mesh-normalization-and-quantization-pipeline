...
class BooleanKeyframeTrack(KeyframeTrack):
    ...
    See https://threejs.org/docs/#api/animation/tracks/BooleanKeyframeTrack
    """
    ...
    def __init__(self, name="", times=None, values=None, interpolation="InterpolateLinear", **kwargs):
        ...
        super(BooleanKeyframeTrack, self).__init__(**kwargs)
...
BooleanKeyframeTrack.__signature__ = inspect.signature(BooleanKeyframeTrack.__init__)
